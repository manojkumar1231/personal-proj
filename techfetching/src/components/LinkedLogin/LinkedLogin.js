...
class LinkedLogin extends Component {
  static propTypes = {
  ...
  click = () => {
    ...
    if (navigator.userAgent.match('CriOS')) {
      window.location.href =
        `https://www.linkedin.com/oauth/v2/authorization?response_type=code&client_id=${appId}` +
        '&redirect_uri=http://537100ce.ngrok.io&state=2522abcde12345&scope=r_basicprofile';
    } else {
      window.FB.login(
        response => {
